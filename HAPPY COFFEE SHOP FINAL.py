...
def helpfun():
    ...
    def discounts():
        ...
        quitbtn.place(x = 50, y = 20, width = 120, height = 30)
        quitbtn.configure(background = "Black", foreground = "Snow")
        ...
        discountMeaning.place(x = 0, y = 170, width = 480)
        discountMeaning.configure(background = "Grey")
    ...
    def namesfun():
        ...
        nameTop.geometry ("500x450")
        nameTop.configure(background = "Grey")
        ...
        nameMeaning.place(x = 0, y = 170, width = 480)
        nameMeaning.configure(background = "Grey")
    ...
    def productsfun():
        ...
        prodTop.geometry ("500x450")
        prodTop.configure(background = "Grey")
    ...
    discount.configure(background = "Black", foreground = "snow")
    ...
    names.configure(background = "Black", foreground = "snow")
    ...
    products.configure(background = "Black", foreground = "snow")
...
tablelbl.configure(background = "grey")
