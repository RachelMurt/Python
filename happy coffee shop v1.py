...
def helpfun():
    ...
    def discounts():
        ...
        part1image.place(x = 50, y = 120)

        quitbtn = Button(top, text = "Close", font = 10, command = lambda: disquit())
        quitbtn.place(x = 300, y = 20)
        quitbtn.configure(background = "SkyBlue4", foreground = "white")
        ...
        discountMeaning.configure(background = "pale green")
    ...
    def namesfun():
        ...
        nameMeaning.configure(background = "pale green")
...
#Date
datelbl = Label(text = "Date: " + time.strftime("%d/%m/%y"))
...
logoimage.configure(background = "SkyBlue1")
logoimage.place(x = 330, y = 50)

#Name Label
namelbl = Label(text = "Customer's Name: ")
namelbl.place(x = 30, y = 70, width=100, height=25)
namelbl.configure(background = "SkyBlue1")
namebox = Entry(text = "")
namebox.place(x = 130, y = 70, width=150, height=25)
namebox.focus()

#Selecting a table dropdown
tablelbl = Label(text = "Select a table: ")
tablelbl.place(x = 30, y = 120, width=100, height=25)
...
button23.place(x = 350, y = 170, width = 120)
button23.configure(background = "gray25", foreground = "white")

button24 = Button(text = "30% off", command = lambda: thirty_per() )
button24.place(x = 350, y = 200, width = 120)
button24.configure(background = "gray25", foreground = "white")

button25 = Button(text = "50% off", command = lambda: fifty_per() )
button25.place(x = 350, y = 230, width = 120)
button25.configure(background = "gray25", foreground = "white")



#total box
display = StringVar()
textbox4 = Label(text = "£{0:.2f}".format(total), fg = "black", bg = "white", font=("Helvetica", 12))
textbox4.place(x = 350, y = 320)
display.set("0")
